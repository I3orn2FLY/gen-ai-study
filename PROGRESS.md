...
| 2026-08-03 | Rule added: **math is LaTeX in `.md`, every symbol defined with dimensions, no magic numbers in formulas**. Lesson 1 part 1 rewritten with a notation table | Kenessary: formulas looked awful; `s_{i-1}` was never defined and 512 was used where $d$ belongs |
