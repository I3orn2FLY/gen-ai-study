...
- **Short parts, plain language.** A lesson is a directory of 3–6 minute parts — **1500 words max,
  ...
  the table above them. Over the ceiling, split the part or delete prose — never compress the
  explanation.
